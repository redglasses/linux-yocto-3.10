...
#define SST_MAX_BUFFER_STEREO		144000 /*500ms@48,24bit,2ch - BYT*/
#define SST_MIN_PERIOD_BYTES_STEREO	64  /*2ms@8,16bit(2Bytes),2ch - BYT*/
#define SST_MAX_PERIOD_BYTES_STEREO	72000 /*250ms@48,24bit,2ch - BYT*/
#define SST_MAX_BUFFER_TDM		576000 /*500ms@48,24bit,8ch - BYT*/
#define SST_MIN_PERIOD_BYTES_TDM	256  /*2ms@8kHz,16bit(2Bytes),8ch - BYT*/
#define SST_MAX_PERIOD_BYTES_TDM	288000 /*250ms@48,24bit,8ch - BYT*/
